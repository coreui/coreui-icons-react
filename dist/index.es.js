...
var CIcon = forwardRef(function (_a, ref) {
    ...
    useMemo(function () { return setChange(change + 1); }, [name, JSON.stringify(content)]);
    var iconName = useMemo(function () { return (name && name.includes('-') ? toCamelCase(name) : name); }, [change]);
    ...
    return use ? (React.createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", className: _className, role: "img" }, rest, { ref: ref }),
        React.createElement("use", { href: use }))) : (React.createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: viewBox, className: _className, role: "img", dangerouslySetInnerHTML: { __html: titleCode + iconCode } }, rest, { ref: ref })));
});
CIcon.propTypes = {
