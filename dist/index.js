...
var CIcon = React.forwardRef(function (_a, ref) {
    var _b;
    var className = _a.className, name = _a.name, content = _a.content, customClassName = _a.customClassName, size = _a.size, title = _a.title, use = _a.use, rest = __rest(_a, ["className", "name", "content", "customClassName", "size", "title", "use"]);
    var _c = React.useState(0), change = _c[0], setChange = _c[1];
    React.useMemo(function () { return setChange(change + 1); }, [name, JSON.stringify(content)]);
    var iconName = React.useMemo(function () { return (name && name.includes('-') ? toCamelCase(name) : name); }, [change]);
    ...
    var _className = customClassName
        ...
        : classNames('icon', (_b = {},
            _b["icon-" + size] = size,
            _b["icon-custom-size"] = rest['height'] || rest['width'],
            _b), className);
    colog('@coreui/icons-react: Please use default export since named exports are deprecated');
    return use ? (React__default['default'].createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", className: _className, role: "img" }, rest, { ref: ref }),
        React__default['default'].createElement("use", { href: use }))) : (React__default['default'].createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: viewBox, className: _className, role: "img", dangerouslySetInnerHTML: { __html: titleCode + iconCode } }, rest, { ref: ref })));
});
CIcon.propTypes = {
